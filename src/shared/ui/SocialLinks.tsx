...
// «Пузырь» из официального логотипа MAX (у react-icons его нет).
// Красится через currentColor, как остальные иконки
export const MaxBubbleIcon: React.FC<{ className?: string }> = ({ className = "" }) => (
