      ...
      <div className='max-w-4xl mx-auto px-4 py-8'>
        ...
        <div className='mb-12'>
          ...
          <p className='text-lg text-gray-700 leading-relaxed mb-4'>
            ...
            В течение двух лет мы собрали сильную команду профессионалов, наладили рабочие процессы,
            а также довели установку и продажу бризеров до совершенства. В 2025 году основали
            компанию PROPRITOK.
          </p>
        </div>
        ...
        <div className='mb-12'>
          ...
          <p className='text-lg text-gray-700 leading-relaxed mb-6'>
            ...
            а также семей с детьми, которым очень необходим ежедневный чистый воздух без
            аллергенов.
          </p>
        </div>
        ...
        <div className='mb-12'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='bg-gray-50 p-6 rounded-lg'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                А для жителей загородных домов и владельцев новостроек приятным бонусом к
                приточной очистке воздуха станет шумоподавление бризера. Никакие посторонние звуки
                не будут мешать вашему отдыху дома.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='bg-white border-2 border-[var(--secondary-color)] p-8 rounded-lg'>
          ...
          <p className='text-lg text-gray-700 leading-relaxed'>
            ...
            сотрудничество. Каждый клиент получает гарантию на монтаж в течение 5 лет и бережную
