            ...
            <div className="max-w-7xl mx-auto px-4">
              <div className="text-center">
                <h1 className="text-5xl font-bold text-white mb-6">
                  Чистый воздух в каждый дом
                </h1>
                <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
                  Бризеры для здорового микроклимата. Установка под ключ с
                  гарантией качества.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Мы понимаем, насколько важно, чтобы система вентиляции
                  работала безупречно. Наша команда квалифицированных
                  специалистов выполняет монтаж бризеров в строгом соответствии
                  с техническими нормами и рекомендациями производителей. Мы
                  настолько уверены в качестве нашей работы, что предоставляем
                  расширенную гарантию 5 лет на монтаж.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 bg-gray-50">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Доверьте монтаж бризера профессионалам, которые используют
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <div>
                <h3 className="text-xl font-semibold mb-4">
                  Профессиональное оборудование HILTI
                </h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Наша команда имеет многолетний опыт работы с системами
                  вентиляции и использует профессиональный инструмент HILTI с
                  пылеудалением, известный своей надежностью и
                  производительностью. Это позволяет нам выполнять монтаж
                  бризеров максимально аккуратно и чисто.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Мы минимизируем количество пыли и строительного мусора во
                  время работы, заботясь о вашем комфорте и чистоте вашего дома.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Благодаря современным технологиям HILTI, мы также снижаем
                  уровень шума при сверлении, делая процесс монтажа максимально
                  комфортным для вас и ваших соседей.
                </p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col items-start sm:flex-row sm:justify-between sm:items-center gap-1 p-3 bg-gray-50 rounded">
                    <span className="font-medium">
                      Монтаж с улучшенным утеплением канала
                    </span>
                    <span className="font-bold text-lg whitespace-nowrap">
                      11 000 ₽
                    </span>
                  ...
                  <div className="flex flex-col items-start sm:flex-row sm:justify-between sm:items-center gap-1 p-3 bg-gray-50 rounded">
                    <span className="font-medium">
                      Монтаж бризера на готовое отверстие
                    </span>
                    <span className="font-bold text-lg whitespace-nowrap">
                      6 000 ₽
                    </span>
            ...
            <div className="bg-gradient-to-r from-[var(--secondary-color)] to-[#B8F0EE] p-8 rounded-lg text-center">
              ...
              <p className="text-xl text-white mb-6">
                При покупке бризера -{" "}
                <span className="font-bold">30% скидка на монтаж</span>
              </p>
              <Button
                size="lg"
                className="bg-white text-[var(--secondary-color)] font-semibold"
