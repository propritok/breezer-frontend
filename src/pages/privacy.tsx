...
const PrivacyPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>Политика конфиденциальности - Propritok</title>
        <meta
          name='description'
          content='Политика в отношении обработки персональных данных компании Propritok'
        />
            ...
            <div className='prose prose-lg max-w-none'>
              <section className='mb-8'>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  ...
                  Смирнов Илья Вячеславович (далее — Оператор).
                </p>
                <p className='text-gray-700 leading-relaxed mb-4'>
                ...
                <p className='text-gray-700 leading-relaxed'>
                  ...
                  посетителях веб-сайта https://propritok.ru/.
                </p>
              </section>
              ...
              <section className='mb-8'>
                ...
                <div className='space-y-3'>
                  ...
                  <p className='text-gray-700 leading-relaxed'>
                    ...
                    сетевому адресу https://propritok.ru/.
                  </p>
                  <p className='text-gray-700 leading-relaxed'>
                  ...
                  <p className='text-gray-700 leading-relaxed'>
                    ...
                    определенному или определяемому Пользователю веб-сайта https://propritok.ru/.
                  </p>
                  <p className='text-gray-700 leading-relaxed'>
                  ...
                  <p className='text-gray-700 leading-relaxed'>
                    2.10. Пользователь — любой посетитель веб-сайта https://propritok.ru/.
                  </p>
                  <p className='text-gray-700 leading-relaxed'>
                ...
                <div className='overflow-x-auto'>
                  <table className='min-w-full border border-gray-300'>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                          обработка заявок, поступивших через формы сайта, и обратная связь с
                          Пользователем (в том числе обратный звонок, консультирование по товарам и
                          услугам)
                        </td>
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                          <ul className='list-disc list-inside space-y-1'>
                        ...
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                          Сбор, запись, хранение, использование, передача персональных данных
                        </td>
                      </tr>
                      <tr>
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                        ...
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                          <ul className='list-disc list-inside space-y-1'>
                            ...
                            <li>IP-адрес</li>
                            <li>
                              обезличенные данные о действиях Пользователя на сайте (сведения об
                              устройстве, браузере, просмотренных страницах)
                            </li>
                          </ul>
                        </td>
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                        ...
                        <td className='border border-gray-300 px-4 py-2 text-gray-700'>
                          Автоматизированный сбор, запись, систематизация, обезличивание, хранение
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <section className='mb-8'>
                <h2 className='text-2xl font-semibold text-gray-800 mb-4'>
                  6.1. Файлы cookie и сервисы аналитики
                </h2>
                <div className='space-y-3'>
                  <p className='text-gray-700 leading-relaxed'>
                    6.1.1. Сайт использует файлы cookie — небольшие текстовые файлы, сохраняемые на
                    устройстве Пользователя, — для корректной работы сайта и анализа посещаемости.
                  </p>
                  <p className='text-gray-700 leading-relaxed'>
                    6.1.2. Для анализа посещаемости сайта используется сервис веб-аналитики
                    Яндекс.Метрика (правообладатель — ООО «ЯНДЕКС», Российская Федерация), в том
                    числе технология «Вебвизор». Сервис обрабатывает обезличенные данные о
                    посещениях (сведения об устройстве и браузере, IP-адрес, просмотренные страницы,
                    действия на сайте) на серверах, расположенных на территории Российской
                    Федерации. Условия обработки данных сервисом определяются документами ООО
                    «ЯНДЕКС».
                  </p>
                  <p className='text-gray-700 leading-relaxed'>
                    6.1.3. Пользователь может отключить сохранение файлов cookie в настройках своего
                    браузера, а также удалить уже сохранённые файлы cookie. Отключение cookie может
              ...
              <section className='mb-8'>
                ...
                <div className='space-y-3'>
                  ...
                  <p className='text-gray-700 leading-relaxed'>
                    7.6. Осуществляется обработка персональных данных, доступ неограниченного круга
              ...
              <section className='mb-8'>
                ...
                <div className='space-y-3'>
                  ...
                  <p className='text-gray-700 leading-relaxed'>
                    ...
                    по адресу{' '}
                    <a
                      href='https://propritok.ru/privacy'
                      className='text-blue-600 hover:text-blue-800 underline'>
                      https://propritok.ru/privacy
                    </a>
                    .
                  </p>
                </div>
